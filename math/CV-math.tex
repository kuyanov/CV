...
{Bachelor in Computer Science, GPA 9.8/10, rank 1/260}{Moscow, Russia}
...
\resumeTwoLineHeading
{HSE, project group ``Combinatorial and numerical problems on lattices''}{January 2023 -- now}{Research assistant}{Moscow, Russia}
\resumeItemListStart
\resumeItem{Research in Mathematical Physics and Number Theory: Feynman checkers.}
\resumeItemListEnd

\resumeTwoLineHeading
{HSE, Laboratory of Theoretical Computer Science}{September 2022 -- now}
...
\resumeItem{Implemented distributed versions of the algorithms such as the Conjugate gradient method and Lanczos algorithm.}
\resumeItemListEnd
